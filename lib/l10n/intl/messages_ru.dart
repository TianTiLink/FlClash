...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(detail) =>
      "Вход выполнен, но импорт узлов не удался: ${detail}. Повторите обновление узлов в разделе «Мой профиль».";

  static String m1(detail) =>
      "Вход выполнен, но синхронизация узлов не удалась: ${detail}";
