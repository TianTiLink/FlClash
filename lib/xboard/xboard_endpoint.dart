...
const String _kEmergencyApiBase = 'https://23.252.106.123';
const String _kBootstrapUrl = '$_kEmergencyApiBase/api/v1/reseller/bootstrap';
const String _kBootstrapBrand = 'yunqie';
const String _kBootstrapPublicKey =
    '9YhNsCkLvwOWXRKw/V8cPpb2wyqhvYnmuiOJlv/tk2w=';

const List<String> _kSeedApiHosts = <String>['https://vm634xcklj68vas12d4.xyz'];
